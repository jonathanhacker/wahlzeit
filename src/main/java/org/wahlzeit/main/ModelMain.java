...
public abstract class ModelMain extends AbstractMain {
	...
	protected void startUp(String rootDir) throws Exception {
		...
		log.config(LogBuilder.createSystemMessage().addAction("init GolfPhotoFactory").toString());
		GolfPhotoFactory.initialize();

		log.config(LogBuilder.createSystemMessage().addAction("load Golf Photos").toString());
		GolfPhotoManager.getInstance().init();
	}
	...
	public void saveAll() throws IOException{
		...
		GolfPhotoManager.getInstance().savePhotos();
	...
	protected void createUser(String userId, String nickName, String emailAddress, String photoDir) {
		...
		GolfPhotoManager photoManager = (GolfPhotoManager) GolfPhotoManager.getInstance();
